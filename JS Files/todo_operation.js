...
function filter_by_statuss(){
  if(document.getElementById("filter_by_status").value === "Status"){
    display_element(todo_array);
  }
 else if(document.getElementById("filter_by_status").value === "Pending")
  {  
    var today = new Date();
  ...
  else if(document.getElementById("filter_by_status").value === "Done")
  {    
    var filtered_array_by_status= todo_array.filter(function(searchstatus){
